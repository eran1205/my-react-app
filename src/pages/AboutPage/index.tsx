        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <p>
              ...
              nulla maiores quam quaerat. Corrupti unde illum suscipit autem
              iure maxime dolorem magni ipsam! Ad officia veritatis aperiam
              nemo. Voluptas at nostrum molestias incidunt necessitatibus,
              sapiente numquam facere explicabo quos, eum cumque repellat quo.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eveniet
              sunt ullam nesciunt beatae deleniti similique aliquam excepturi,
              minus nobis minima ex atque, quos veniam architecto doloribus
              maxime sapiente. Vel voluptatem pariatur delectus dolor quidem
              eveniet repellat facere tempora nisi. Ut!
            </p>
          </div>
        </div>
      </div>
